...
class QuoteRequestDto
{
    ...
    public function getArtisanType(): ?string
    {
        return $this->artisanType;
    }

    public function setArtisanType(?string $artisanType): self
    {
    ...
    public function getDesiredDelay(): ?string
    {
        return $this->desiredDelay;
    }

    public function setDesiredDelay(?string $desiredDelay): self
    {
    ...
    public function isContactChat(): ?bool
    {
        return $this->contactChat;
    }

    public function setContactChat(?bool $contactChat): self
    {
    ...
    public function getCallbackAvailability(): ?string
    {
        return $this->callbackAvailability;
    }

    public function setCallbackAvailability(?string $callbackAvailability): self
    {
        $this->callbackAvailability = $callbackAvailability;

        return $this;
    }

    public function getInterventionMoment(): ?string
    {
        return $this->interventionMoment;
    }

    public function setInterventionMoment(?string $interventionMoment): self
    {
        $this->interventionMoment = $interventionMoment;
